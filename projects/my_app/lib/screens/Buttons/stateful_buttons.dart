          ...
          children: [
            ...
            Stepper(
              ...
              steps: const [
                Step(
                  title: Text("Login"),
                  content: Text("Enter Login details"),
                ),
            ...
            Row(
              ...
              children: [
                Chip(label: Text("Flutter"), avatar: Icon(Icons.flutter_dash)),
                Chip(label: Text("Android"), avatar: Icon(Icons.android)),
                Chip(label: Text("IOS"), avatar: Icon(Icons.ios_share)),
              ],
            ),
            SizedBox(height: 20),
            ActionChip(
              ...
              onPressed: () {
                ScaffoldMessenger.of(
                  context,
                ).showSnackBar(SnackBar(content: Text("Action Chip Clicked")));
              },
            ),
            SizedBox(height: 20),
            ChoiceChip(
